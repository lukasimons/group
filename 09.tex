...
(G:K)=(G:H)(H:K)=pm
\]
and hence $pm$ divides $p!$. This implies that $m$ divides $(p-1)!$. If $q$ is a prime number dividing 
...
\]
Note that the action of $L$ on $X$ is transitive, since for any $hk, h_1k_1\in HK$ it holds that $(h_1h^{-1}, k_1^{-1}k)\cdot hk = h_1k_1$.
